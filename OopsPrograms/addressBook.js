...
var fs = require('fs');
var data = fs.readFileSync('/home/admin1/HitheshGR/OopsPrograms/JSONfiles/addressBook.json');
...
class Address {
    ...
    createAddress() {
         ...
         */
        fs.writeFile('addressBook1.json', JSON.stringify(addressb), 'utf-8', function (err) {
            if (err) throw err
            console.log('Done!');
        })
